...
namespace Store.Web.Controllers
{
    public class OrderController : Controller
    {
        ...
        public OrderController(IDetailRepository detailRepository, IOrderRepository orderRepository, IEnumerable<IDeliveryService> deliveryServices, INotificationService notificationService)
        {
